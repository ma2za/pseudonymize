...
The engine is strictly gated on detection accuracy against the \i4privacy/pii-masking-openpii-1.5m\ dataset (validation split, 10000 randomly sampled rows).

**Current Baseline (0.22.0 - 10k validation):**
- **Precision:** 0.9377
- **Recall:** 0.9477
- **F1 Score:** 0.9427
