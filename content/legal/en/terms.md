...
pseudonymize.io provides a deterministic pseudonymization API designed to help developers protect PII while maintaining relational data integrity.
...
The service is provided "as is" without warranties of any kind. In no event shall pseudonymize.io be liable for any indirect, incidental, or consequential damages arising out of your use of the API.

## 5. Open Source
Our core pseudonymization engine is open-source. While the hosted platform is commercial, you are free to inspect our open-source codebase on GitHub to understand our methodologies.
