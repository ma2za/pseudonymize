...
def main() -> None:
    ...
    if sys.platform == "win32":
        ...
        if shutil.which("winget"):
            print("Running: winget install -e --id UB-Mannheim.TesseractOCR --accept-package-agreements --accept-source-agreements")
            ...
            if result.returncode != 0 and "No available upgrade found" not in result.stdout:
                ...
                sys.exit(1)
            print("Tesseract installed (or already installed) successfully to C:\\Program Files\\Tesseract-OCR\\")
        else:
            print("winget not found. Please install Tesseract from: https://github.com/UB-Mannheim/tesseract/wiki")
            sys.exit(1)
        ...
        if shutil.which("brew"):
            ...
            print("Homebrew not found. Please install from https://brew.sh/ or install Tesseract manually.")
            sys.exit(1)
        ...
        if shutil.which("apt-get"):
            ...
            print("apt-get not found. Please use your package manager (e.g., yum, pacman, apk) to install `tesseract-ocr`.")
            sys.exit(1)
